#############################################################################
# Makefile for building: timeprofile
# Generated by qmake (3.1) (Qt 5.12.3)
# Project:  timeprofile.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile timeprofile.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_DEPRECATED_WARNINGS -DQCUSTOMPLOT_USE_OPENGL -DQT_NO_DEBUG -DQT_PRINTSUPPORT_LIB -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
INCPATH       = -I. -I. -isystem /usr/include/qt -isystem /usr/include/qt/QtPrintSupport -isystem /usr/include/qt/QtWidgets -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtCore -I. -isystem /usr/include/libdrm -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = timeprofile1.0.0
DISTDIR = /home/chinmaya/code/src/github.com/chin123/timeprofile/.tmp/timeprofile1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now
LIBS          = $(SUBLIBS) -lQt5PrintSupport -lQt5Widgets -lQt5Gui -lQt5Core /usr/lib/libGL.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = main.cpp \
		qcustomplot.cpp \
		creategraph.cpp moc_qcustomplot.cpp
OBJECTS       = main.o \
		qcustomplot.o \
		creategraph.o \
		moc_qcustomplot.o
...
Makefile: timeprofile.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile timeprofile.pro
...
moc_qcustomplot.cpp: qcustomplot.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/chinmaya/code/src/github.com/chin123/timeprofile/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/chinmaya/code/src/github.com/chin123/timeprofile -I/home/chinmaya/code/src/github.com/chin123/timeprofile -I/usr/include/qt -I/usr/include/qt/QtPrintSupport -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/8.3.0 -I/usr/include/c++/8.3.0/x86_64-pc-linux-gnu -I/usr/include/c++/8.3.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/8.3.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/8.3.0/include-fixed -I/usr/include qcustomplot.h -o moc_qcustomplot.cpp
...
creategraph.o: creategraph.cpp creategraph.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o creategraph.o creategraph.cpp
